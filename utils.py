...
def format_final_json(video_url, metrics, llm_result):
    ...
    final_output = {
        ...
        "metrics": {
            ...
            "operators": metrics.get('operators', {'names': [], 'timestamps': {}}),

            "agents": metrics.get('operators', {}).get('names', []) if isinstance(metrics.get('operators'), dict) else [],
            ...
            "primary_weapons": metrics.get('primary_weapons', []),

            "secondary_weapons": metrics.get('secondary_weapons', []),
